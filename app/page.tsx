...
export const metadata: Metadata = {
  title: 'Courtier en crédit européen — Prêts immobiliers et professionnels',
  description:
    'Consortium Finanzen Kredit vous accompagne dans tous vos projets de financement en Europe. Prêts immobiliers, professionnels, personnels — conseil indépendant depuis Francfort.',
}
...
const TESTIMONIALS = [
  {
    quote: "Dossier déposé le matin, réponse complète le soir même. Taux excellent et démarches simplifiées. Un service que je recommande sans hésitation.",
    name: 'Thomas B.',
  ...
  {
    quote: "Processus simple et totalement transparent. Mon financement automobile a été validé rapidement, sans aucune complication.",
    name: 'Martin K.',
    location: 'Hambourg, Allemagne',
    amount: '24 500 €',
    type: 'Financement automobile',
  },
  {
    quote: "Le regroupement de mes crédits m'a permis de réduire significativement mes mensualités. Un accompagnement professionnel du début à la fin.",
    name: 'Andreas W.',
    location: 'Munich, Allemagne',
    amount: '42 000 €',
    type: 'Regroupement de crédits',
  },
  {
    quote: "Financement obtenu pour développer mon activité professionnelle. Dossier traité avec sérieux et une réactivité remarquable.",
    name: 'Stefan H.',
    location: 'Francfort, Allemagne',
    amount: '75 000 €',
    type: 'Prêt professionnel',
  },
  {
    quote: "Un accompagnement sérieux et efficace depuis Genève. Mon projet a été financé avec des conditions très satisfaisantes.",
    name: 'Jean-Paul M.',
  ...
  {
    quote: "Réponse rapide et dossier accepté sans difficulté. Un service accessible et professionnel, même depuis la France.",
    name: 'Claire F.',
...
const PARTNERS = [
  {
    flag: '🇩🇪', country: 'Allemagne', name: 'Partenaire Allemagne 1',
    desc: 'Établissement financier spécialisé dans le crédit à la consommation et les prêts personnels.',
  ...
  {
    flag: '🇩🇪', country: 'Allemagne', name: 'Partenaire Allemagne 2',
    desc: 'Organisme de crédit reconnu, solutions de financement pour les particuliers et professionnels.',
  ...
  {
    flag: '🇩🇪', country: 'Allemagne', name: 'Partenaire Allemagne 3',
    desc: 'Institution financière offrant des solutions de financement immobilier et professionnel.',
  ...
  {
    flag: '🇨🇭', country: 'Suisse', name: 'Partenaire Suisse',
    desc: 'Établissement financier suisse, accompagnement des clients transfrontaliers et résidents.',
  ...
  {
    flag: '🇫🇷', country: 'France', name: 'Partenaire France',
    desc: 'Organisme de crédit agréé en France, spécialisé dans les prêts personnels et immobiliers.',
  ...
  {
    flag: '🇳🇱', country: 'Pays-Bas', name: 'Partenaire Pays-Bas',
    desc: 'Institution financière néerlandaise, solutions de financement pour résidents et non-résidents.',
...
const FAQ = [
  {
    q: "Quel montant puis-je demander ?",
    a: "De 5 000 € à 500 000 € selon le profil et le projet.",
  },
  {
    q: "Combien de temps faut-il pour obtenir une réponse ?",
    a: "Sous 24h pour les prêts personnels et sous 72h pour les autres financements.",
  },
  {
    q: "Dois-je résider en Allemagne ?",
    a: "Non, certains financements sont accessibles dans plusieurs pays européens.",
  },
  {
    q: "Les demandes sont-elles gratuites ?",
    a: "Oui, l'étude du dossier est entièrement gratuite.",
  },
  {
    q: "Quels documents sont nécessaires ?",
    a: "Une pièce d'identité, des justificatifs de revenus et les documents liés au projet.",
  },
  {
    q: "Mes données sont-elles sécurisées ?",
    a: "Oui, les informations transmises sont traitées de manière confidentielle.",
  },
  {
    q: "Puis-je rembourser mon crédit par anticipation ?",
    a: "Selon les conditions du financement proposé.",
  },
  {
    q: "Comment suivre ma demande ?",
    a: "Un conseiller vous contacte directement par email ou téléphone.",
  },
]
...
export default function HomePage() {
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-1.5 text-sm text-slate-200 font-medium mb-6">
              ...
              Courtier en crédit européen — Francfort
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              Votre financement,{' '}
              <span className="text-gold-400">notre expertise</span>
            </h1>

            <p className="text-lg sm:text-xl text-slate-300 leading-relaxed mb-8 max-w-2xl">
              Consortium Finanzen Kredit vous accompagne dans tous vos projets de financement en Europe.
              Prêts immobiliers, professionnels, personnels — conseil indépendant et solutions sur mesure.
            </p>
            ...
            <ul className="mt-10 flex flex-wrap gap-5 text-sm text-slate-400" aria-label="Garanties">
              {['Activité réglementée', 'Conforme RGPD', '5 pays européens', 'Conseil indépendant'].map(g => (
      ...
      {/* ── STATS ───────────────────────────────────────────── */}
      <section aria-label="Nos chiffres clés" className="bg-white border-b border-slate-100 py-12">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-slate-500 max-w-2xl mx-auto">
              Des solutions adaptées à chaque profil et chaque projet, en Allemagne et dans toute l'Europe.
            </p>
          </div>
      ...
      <section aria-labelledby="process-heading" className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-slate-500 max-w-2xl mx-auto">
              Un parcours simple et transparent, de votre première demande jusqu'au déblocage des fonds.
            </p>
          </div>
      ...
      <section id="simulateur" aria-labelledby="sim-heading" className="bg-slate-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-500 max-w-2xl mx-auto">
              Estimez vos mensualités en quelques secondes. Résultats indicatifs — nos conseillers affinent avec vous.
            </p>
          </div>
          <LoanSimulator />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 id="why-heading" className="text-3xl sm:text-4xl font-bold mb-4">
              Pourquoi choisir{' '}
              <span className="text-gold-400">Consortium Finanzen Kredit</span> ?
            </h2>
          </div>
      ...
      <section aria-labelledby="testimonials-heading" className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-slate-500 max-w-2xl mx-auto">
              Des centaines de clients nous ont fait confiance pour leurs projets de financement en Europe.
            </p>
          </div>
          <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {TESTIMONIALS.map(({ quote, name, location, amount, type }) => (
              <li key={name} className="bg-slate-50 border border-slate-100 rounded-2xl p-6 flex flex-col hover:border-primary-200 hover:shadow-sm transition-all duration-200">
                <div aria-label="Note 5 étoiles" className="flex gap-1 mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 id="partners-heading" className="text-3xl sm:text-4xl font-bold text-primary-950 mb-4">
              Notre réseau financier européen
            </h2>
            <p className="text-lg text-slate-500 max-w-2xl mx-auto">
              Nous collaborons avec différents établissements financiers afin d'étudier chaque dossier selon son profil.
            </p>
          </div>
          <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {PARTNERS.map(({ flag, country, name, desc, color, icon }) => (
              <li key={name} className="bg-white border border-slate-100 rounded-2xl p-6 flex flex-col gap-4 hover:border-primary-200 hover:shadow-sm transition-all duration-200">
                <div className="flex items-start justify-between">
                  ...
                  <span className="text-2xl" aria-label={`Drapeau ${country}`}>{flag}</span>
                </div>
                <div>
          ...
          <p className="text-center text-xs text-slate-400 mt-8">
            Les noms affichés sont des désignations génériques. Aucun partenariat officiel avec des établissements nommément désignés n'est revendiqué.
          </p>
        </div>
      </section>
      ...
      <section aria-labelledby="faq-heading" className="bg-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-10">
            <p className="text-slate-500 text-sm mb-4">Vous n'avez pas trouvé votre réponse ?</p>
            <Link href="/contact"
      ...
      <section aria-labelledby="cta-heading" className="bg-gradient-to-r from-primary-900 to-primary-800 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-slate-300 mb-8">
            Prêts personnels traités sous 24h. Autres financements sous 72h. Première consultation gratuite.
          </p>
